...
public class DoneeSearchDonationHistoriesController {
    ...
    public List<DonationResponse> searchDonationHistories(Donation.Status status, String title, @NotBlank String orderBy) {
        ...
        if (currentUserRole == UserProfile.Name.DONEE) {
            ...
            donationResponseList = donation.searchDonationHistories(status, title, orderBy, currentUserId);
        }
